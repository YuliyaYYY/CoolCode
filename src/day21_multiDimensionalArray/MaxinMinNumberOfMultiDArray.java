...
public class MaxinMinNumberOfMultiDArray {

    public static void main(String[] args) {


        // inx of elements     0    1   2     0    1    2       0    1   2
        int[][] array = {{100, 20, 300}, {10, 1000, 50}, {-200, 400, 0}}; // index of array: 0,1,2
        // inx of 1D array         0               1               2
